...
// 2009.1.24 tkoishi@b-shock.co.jp
//require_once('Format.php');
//require_once('OLEwriter.php');
//require_once('BIFFwriter.php');
BSUtility::includeFile('write_excel/Format.php');
BSUtility::includeFile('write_excel/OLEwriter.php');
BSUtility::includeFile('write_excel/BIFFwriter.php');
//
...
class Workbook extends BIFFwriter
{
    ...
    */
    ...
    {
         $format = $this->add_format($properties);
         return $format;
    }
