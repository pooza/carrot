 ...
 * @since     3.0.0
 * @version   $Id: ValidatorConfigHandler.class.php 226 2008-04-22 01:36:41Z pooza $
 */
class ValidatorConfigHandler extends BSConfigHandler
{
                                     ...
                                     &$ini, &$list)
    {
        ...
        foreach ($ini['names'] as $key => &$value)
        {
            ...
            } else
            {
                ...
                $entry[$attribute] = parent::literalize($value);
